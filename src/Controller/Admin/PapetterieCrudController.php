...
class PapetterieCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_INDEX, 'Gestion de la Page Papeterie')
            ->setPageTitle(Crud::PAGE_NEW, 'Nouvelle page')
            ->setPageTitle(Crud::PAGE_EDIT, 'Modification Page Papeterie')
            ->setPageTitle(Crud::PAGE_DETAIL, 'Détails de la Page Papeterie');
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::DELETE, function (Action $action) {
                return $action->setLabel('Supprimer la page PAPETERIE');
            })
            // Modifier le texte du bouton "New"
            ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
                return $action->setLabel('Ajouter une nouvelle page PAPETERIE');
            })
