 ...
 */
final class Version20250924111646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC279D28E534 FOREIGN KEY (fk_categorie_id) REFERENCES categorie (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC279D28E534 ON produit (fk_categorie_id)');
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC279D28E534'); // supprime la contrainte
        $this->addSql('ALTER TABLE produit DROP INDEX IDX_29A5EC279D28E534');      // supprime l’index
        $this->addSql('ALTER TABLE produit DROP COLUMN fk_categorie_id');          // supprime la colonne
