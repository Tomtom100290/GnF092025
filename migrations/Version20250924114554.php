 ...
 */
final class Version20250924114554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD fk_categorie_produit_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC273797863B FOREIGN KEY (fk_categorie_produit_id) REFERENCES categorie (id)');
        $this->addSql('CREATE INDEX IDX_29A5EC273797863B ON produit (fk_categorie_produit_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_29A5EC273797863B ON produit');
        $this->addSql('ALTER TABLE produit DROP fk_categorie_produit_id');
    }
}
